...
public class AudioChunkService {
    ...
    public AudioChunkResponseDTO uploadChunk(UUID meetingId, Integer sequenceNumber, MultipartFile file, UUID userId) {
    ...
    public List<AudioChunkResponseDTO> getChunksForMeeting(UUID meetingId, UUID userId) {
        ...
        List<AudioChunkEntity> chunks = chunkRepository.findByMeetingIdOrderBySequenceNumberAsc(meetingId);
    ...
    public ChunkProgressResponseDTO getProgress(UUID meetingId, UUID userId) {
        ...
        long totalChunks = chunkRepository.countByMeetingIdAndStatus(meetingId, ChunkStatus.UPLOADED);
